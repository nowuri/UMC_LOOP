 ...
 * Use the [HomeGyeonggi.newInstance] factory method to
 * create an instance of this fragment.
 */
class HomeGyeonggi : Fragment() {
    ...
    override fun onCreateView(
        ...
        val DataRVAdapter = HomeAdapter2(mainActivity, dataList)
    ...
    companion object {
         ...
         * @return A new instance of fragment HomeGyeonggi.
         */
