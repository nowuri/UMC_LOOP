 ...
 * Use the [Jeju.newInstance] factory method to
...
class Jeju : Fragment() {
    ...
    override fun onCreateView(
        ...
        val DataRVAdapter11 = DataRVAdapter11(mainActivity, dataList)
                    ...
                    override fun onResponse(
                        ...
                        if(response.isSuccessful()) {
                            ...
                            if (jsonArray != null) {
                                ...
                                viewbinding.rvRefrigerator.adapter = DataRVAdapter11
                            }
                        }
                        else {
    ...
    companion object {
         ...
         * @return A new instance of fragment Jeju.
         */
