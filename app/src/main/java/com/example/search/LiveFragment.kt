...
import com.example.interested.databinding.FragmentLiveBinding
...
class LiveFragment : Fragment() {
    ...
    private lateinit var viewbinding: FragmentLiveBinding
    ...
    override fun onCreateView(
        ...
        viewbinding = FragmentLiveBinding.inflate(layoutInflater)

        val DataRVAdapter3 = DataRVAdapter3(mainActivity, dataList)
                    ...
                    override fun onResponse(
                        ...
                        if(response.isSuccessful()) {
                            ...
                            if (jsonArray != null) {
                                ...
                                viewbinding.rvRefrigerator.adapter = DataRVAdapter3
                            }
                        }
                        else {
