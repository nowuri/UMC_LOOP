...
class MoneyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewbinding = FragmentMoneyBinding.inflate(layoutInflater)

        val DataRVAdapter4 = DataRVAdapter4(mainActivity, dataList)
                    ...
                    override fun onResponse(
                        ...
                        if(response.isSuccessful()) {
                            ...
                            if (jsonArray != null) {
                                ...
                                viewbinding.rvRefrigerator.adapter = DataRVAdapter4
                            }
                        }
                        else {
