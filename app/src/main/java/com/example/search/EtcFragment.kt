 ...
 * Use the [EtcFragment.newInstance] factory method to
...
class EtcFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val DataRVAdapter6 = DataRVAdapter6(mainActivity, dataList)
                    ...
                    override fun onResponse(
                        ...
                        if(response.isSuccessful()) {
                            ...
                            if (jsonArray != null) {
                                ...
                                viewbinding.rvRefrigerator.adapter = DataRVAdapter6
                            }
                        }
                        else {
