...
import com.example.interested.databinding.FragmentGyeonggiBinding
 ...
 * Use the [Gyeonggi.newInstance] factory method to
 * create an instance of this fragment.
 */
class Gyeonggi : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private lateinit var viewbinding: FragmentGyeonggiBinding
    ...
    override fun onCreateView(
        ...
        viewbinding = FragmentGyeonggiBinding.inflate(layoutInflater)

        val DataRVAdapter8 = DataRVAdapter8(mainActivity, dataList)
    ...
    inner class RetrofitWork(private val field: String) {
                    ...
                    override fun onResponse(
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (jsonArray != null) {
                                ...
                                viewbinding.rvRefrigerator.adapter = DataRVAdapter8
                            }
                        } else {
         ...
         * @return A new instance of fragment Gyeonggi.
         */
