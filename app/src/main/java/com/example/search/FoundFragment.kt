...
import com.example.interested.databinding.FragmentEtcBinding
...
class FoundFragment : Fragment() {
    ...
    private lateinit var viewbinding: FragmentFoundBinding
    ...
    override fun onCreateView(
        ...
        viewbinding = FragmentFoundBinding.inflate(layoutInflater)

        val DataRVAdapter2 = DataRVAdapter2(mainActivity, dataList)
                    ...
                    override fun onResponse(
                        ...
                        if(response.isSuccessful()) {
                            ...
                            if (jsonArray != null) {
                                ...
                                viewbinding.rvRefrigerator.adapter = DataRVAdapter2
                            }
                        }
                        else {
