...
exports.HomeListForRegion = async function(req, res) {
  ...
  try {
    ...
    const totalcnt = parsedData.empsInfo["totalCnt"];
    ...
    for(var i = 0; i < 5; i++){
      ...
      json.department = parsedData.empsInfo.emp[i].cnsgNmor;

      jsonArray.push(json);

    }
    console.log(jsonArray);
    return res.send(response(baseResponseStatus.SUCCESS, jsonArray));
